...
(function ($, _, Backbone, Backgrid, lunr) {
  ...
  */
  var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backbone.View.extend({
    ...
    /** @property */
    className: "backgrid-filter col-md-4 pull-right",

    /** @property {function(Object, ?Object=): string} template */
    template: _.template('<div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input class="form-control" type="text" <% if (placeholder) { %> placeholder="<%- placeholder %>" <% } %> name="<%- name %>" /><span class="input-group-addon"><a class="close" href="#">&times;</a></span></div>'),
